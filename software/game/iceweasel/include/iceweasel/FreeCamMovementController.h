...
class FreeCamMovementController : public Urho3D::Component
{
    URHO3D_OBJECT(FreeCamMovementController, Urho3D::Component)
     ...
     * attached).
     */
    FreeCamMovementController(Urho3D::Context* context, Urho3D::Node* cameraNode);
